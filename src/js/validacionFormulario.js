...
function validarFormulario() {
    ...
    if (nombre === '') {
        mostrarError('nombreFeedback', 'Por favor, ingresa tu nombre.');
        isValid = false;
    } else {
    ...
    if (apellido === '') {
        mostrarError('apellidoFeedback', 'Por favor, ingresa tu apellido.');
        isValid = false;
    } else {
    ...
    if (email === '' || !validarEmail(email)) {
        mostrarError('emailFeedback', 'Por favor, ingresa un correo electrónico válido.');
        isValid = false;
    } else {
    ...
    if (telefono === '') {
        mostrarError('telefonoFeedback', 'Por favor, ingresa tu número de teléfono.');
        isValid = false;
    } else {
    ...
    if (compania === '') {
        mostrarError('companiaFeedback', 'Por favor, ingresa el nombre de tu compañía.');
        isValid = false;
    } else {
    ...
    if (!terms) {
        mostrarError('termsFeedback', 'Tiene que aceptar los términos y condiciones.');
        isValid = false;
    } else {
